...
SKILLS={
	...
	xinyan={ --心眼
		...
		poisonenhance_p={{{1,30},{30,30},{33,30},{35,30},{38,30}},{{1,-1},{2,-1}}},
	...
	shehun_yueying={ --摄魂月影
		...
		seriesdamage_p={{{1,20},{15,60},{20,100},{21,102}}},
		poisondamage_v={{{1,5},{20,31}},{{1,60},{20,60}},{{1,10},{20,10}}},
		deadlystrike_p={{{1,10},{20,79}}},
		...
		missle_speed_v={{{1,28},{20,35},{21,35}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
	...
	yindao_sheyue={ --银刀射月
		seriesdamage_p={{{1,20},{20,100},{21,102}}},
		physicsenhance_p={{{1,25},{20,150}}},
	},
	feidaotang150={ --飞刀唐150
		physicsenhance_p={{{1,30},{15,80},{20,160},{23,276},{26,384}}},
	...
	baoyu_lihua={ --暴雨梨花
		seriesdamage_p={{{1,20},{15,40},{20,100},{21,102}}},
	...
	zhuixing_zhudian={ --追星逐电
		seriesdamage_p={{{1,20},{20,100},{21,102}}},
		poisondamage_v={{{1,1},{20,20}},{{1,60},{20,60}},{{1,10},{20,10}}},
	},
	nutang150={ --弩唐门150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
